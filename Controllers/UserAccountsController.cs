...
namespace Daily_Expenses_Final.Controllers
{
    ...
    public class UserAccountsController : Controller
    {
        ...
        public UserAccountsController(Daily_Expenses_DataContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email")] UserAccount userAccount)
        {
